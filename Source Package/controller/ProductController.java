            ...
            try {
                ...
                if (rawIds != null && rawQuantityArr != null) {
                    ...
                    for (int i = 0; i < rawIds.length; i++) {
                        ...
                        if (!rawDAO.hasEnoughQuantity(rawId, rawQuantity)) {
                            insufficientRaw = true;
                            errorMessage = "Insufficient quantity of raw material '" + raw.getName() + "'. Required: " + rawQuantity + ", Available: " + raw.getQuantity();
                            break;
                        }
                        
                        // Add to map if all checks pass
