...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <div class="logo">
            ...
            <div class="logo-text">Five Blooms</div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto nav-links">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/productPage">Shop</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/view/common/FAQpage.jsp">FAQ</a>
                </li>
